            ...
            <div className='pokeList'>
              {pokemonList.map((result, i) => (
                <div
                  ...
                  key={i}
                  onClick={this.clickedOn.bind(this, result.url)}>
                  <Item name={result.name} url={result.url} />
                </div>
              ))}
            </div>
            <div>
              {this.props.pokemonPrev ? (
                <p
                  className='navButton'
                  onClick={this.prevButton.bind(this, this.props.pokemonPrev)}>
                  Previous
                </p>
              ) : (
                <p className='navButton disabled'>Previous</p>
              )}
              {this.props.pokemonNext ? (
                <p
                  className='navButton'
                  onClick={this.nextButton.bind(this, this.props.pokemonNext)}>
                  Next
                </p>
              ) : (
                <p className='navButton disabled'>Next</p>
              )}
            </div>
          </React.Fragment>
        ) : (
...
export default connect(
  mapStateToProps,
  { getPokemonList, getPokemonInfo, getNextPokemon, getPreviousPokemon }
)(Itemlist);
